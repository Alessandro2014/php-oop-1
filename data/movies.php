...
$movies = [
    [
        ...
        'gender' => 'Dramatic',
        'year' => '2016',
        'plot' => 'Lion - La strada verso casa, film diretto da Garth Davis, racconta la storia di Saroo, un bambino di cinque anni che vive con la sua povera famiglia a Khandwa, 
        un piccolo villaggio dell\'India centrale. Insieme a suo fratello più grande trascorre le giornate a raccogliere metalli per poi rivenderli e guadagnare qualche soldo. 
        Una notte i due devono lavorare in una stazione, ma il piccolo Saroo è talmente stanco che si addormenta sulla panchina di fronte ai vagoni. Quando si risveglia è solo e spaventato, 
        non trova più il fratello e, non sapendo cosa fare, decide di salire su un treno vuoto. Questo, però, non fa alcuna fermata e lo porta direttamente a Calcutta, a quasi duemila chilometri da casa.',
        'forAge' => 13,
    ],
    [
        'id' => 2,
        'title' => 'La La Land',
        'gender' => 'Commedia, Drammatico,',
        'year' => '2016',
        'plot' => 'La La Land è un film del 2016 diretto da Damien Chazelle.
